@extends('admin.layouts.index') @section('title') DashBoard @endsection @section('wrapper')
<!-- top tiles -->
...
@section('script')
<script>
   var _labelsUser =  {!! json_encode($labels_user) !!}
   var _dataUser = {!! json_encode($data_user) !!}
   var _labelsProduct =  {!! json_encode($labels_product) !!}
   var _dataProduct = {!! json_encode($data_product) !!}
</script>
@endsection
